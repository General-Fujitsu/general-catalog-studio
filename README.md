...
- **Raumrechner:** 1–5 Räume mit Name, Fläche, W/m², Bauart und Leitungslänge. Berechnet Innengeräte,
  passende Außeneinheit (mit Indexsummen-Prüfung), Kältemittelleitungen als 25-m-Ringe, Refco-Pumpen
  nur für Geräte ohne integrierte Pumpe sowie Montagezubehör je nach Aufstellung (Dämmsockel,
  Wandkonsole oder Dachkonsole) – komplett bepreist, mit Kommissionsfeld.
- **Produktfotos:** je Geräteserie direkt aus dem Katalog-PDF freigestellt (46 Innengeräte-,
  9 Außengerätebilder). Zubehör bleibt bewusst ohne Bild.
- **Fernbedienungen:** je Serie nur die, die auf der zugehörigen Katalog-Doppelseite abgedruckt sind.
  Beachtet, dass die Fernbedienungs-Sets je Gerätefamilie eigene Artikelnummern haben (z. B. Truhen:
  2624770 statt 2607644). Basic-Wandmodelle zeigen korrekt keine, weil dort keine Kabel-FB anschließbar ist.
- **Dokumentart:** In der Ausgabe umschaltbar zwischen Bestellung und Angebot – Betreff und
  Anschreiben passen sich an.
