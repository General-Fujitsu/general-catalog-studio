...
- **Auslegungs-Import:** Datei per Drag & Drop oder Auswahl laden (TXT, CSV, XLSX, PDF, JSON) oder Text
  einfügen. Artikelnummern und Modellbezeichnungen werden mit Mengen erkannt, Mengen sind korrigierbar,
  mehrdeutige Modelle (z. B. Single-Set oder Multi-Inneneinheit) lassen sich je Position umstellen –
  danach direkt „Als Angebot übernehmen".
